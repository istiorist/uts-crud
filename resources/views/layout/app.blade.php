...
<head>
    ...
    <link rel="apple-touch-icon" href="/template/apple-icon.png">
        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <li class="active">
                        <a href="{{ url('/data_pasien') }}"> <i class="menu-icon fa fa-dashboard"></i>Data Pasien </a>
                    </li>
                    <li class="active">
                        <a href="{{ url('/data_pasien') }}"> <i class="menu-icon fa fa-dashboard"></i>Data Dokter </a>
                    </li>
                    <li class="active">
                        <a href="{{ url('/data_pasien') }}"> <i class="menu-icon fa fa-dashboard"></i>Daftar Rumah Sakit </a>
                    </li>
                    <li class="active">
                        <a href="{{ url('/data_pasien') }}"> <i class="menu-icon fa fa-dashboard"></i>Daftar Apotek </a>
                    </li>
                </ul>
            </div><!-- /.navbar-collapse -->
        </nav>
